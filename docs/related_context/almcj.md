# ALM Blueprint Update - December 18, 2025
...
4.  **Phase 4: Validation & Non-Coupled Observability**
    *   Expose internal side-channel metrics for key spiral properties (e.g., residual energy, symmetry deviation, radial drift, angular velocity, persistence half-life).
